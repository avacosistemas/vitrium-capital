        ...
        <section id="planos">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <img src="assets/images/proyectos/01_vila/niveles/azotea.jpg" class="img-fluid d-block mx-auto" style="margin-bottom: 20px;" />
                    </div>
        ...
        <section id="thumbs_deptos">
            <div class="container">
                <div class="row imagen_nivel_sin_deptos nivel_subsuelo">
                    <div class="col-12">
                        <img src="assets/images/proyectos/01_vila/niveles/azotea_texto.png" class="img-fluid d-block mx-auto" />
                    </div>
                </div>
            </div>
        </section>
