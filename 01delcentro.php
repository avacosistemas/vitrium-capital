            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-xl-8">
                        <div class="banner_principal_img" style="background-image: url('assets/images/proyectos/01_delcentro/bannerprincipal.jpeg')">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="big_cta_cont" style="background-image: url(assets/images/proyectos/01_delcentro/background_cta.png)">
                            ...
                            <a href="assets/brochures/01delCentro_brochure.pdf" target="_blank" class="big_button  wow fadeInUp" data-wow-delay="1s">Descargar brochure</a>
                        </div>
                    </div>
                </div>
            </div>
